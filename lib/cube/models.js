...
Event.prototype.to_wire = function(){
  if (this._id) return { t: this.t, d: this.d, _id: this._id };
  else          return { t: this.t, d: this.d };
};
...
Event.prototype.save = function(callback){
  var self = this;
  db.events(self.type, function(error, collection){
...
Metric.prototype.to_wire = function to_wire(){
  return { i: false, v: this.value, _id: { e: this.e, l: this.tier.key, t: time } };
};
