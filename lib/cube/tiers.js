...
tiers[second10] = {
  ...
  bin:   function(d) { return Math.floor(d / second10); },
  ceil: tier_ceil,
...
tiers[minute] = {
  ...
  bin:   function(d) { return Math.floor(d / minute); },
  ceil: tier_ceil,
...
tiers[minute5] = {
  ...
  bin:   function(d) { return Math.floor(d / minute5); },
  ceil: tier_ceil,
...
tiers[hour] = {
  ...
  bin:   function(d) { return Math.floor(d / hour); },
  ceil: tier_ceil,
...
tiers[day] = {
  ...
  bin:   function(d) { return Math.floor(d / day); },
  ceil: tier_ceil,
