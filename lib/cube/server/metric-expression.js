  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "event_group_expression": parse_event_group_expression,
      ...
      function parse_metric_unary_expression() {
        ...
        var result4 = result3 !== null
          ? (function(expression) { var value = expression.value; expression.value = function(o) { return -value(o); }; return expression; })(result3[2])
          : null;
        if (result4 !== null) {
          var result2 = result4;
        } else {
      ...
      function parse_metric_primary_expression() {
        ...
        var result14 = result13 !== null
          ? (function(reduce, event) { event.reduce = reduce; event.source = input.substring(savedPos1, pos); return event; })(result13[0], result13[4])
          : null;
        if (result14 !== null) {
        ...
        if (result3 !== null) {
          ...
          if (result12 !== null) {
            ...
            if (result13 !== null) {
              ...
              if (result14 !== null) {
                var result15 = parse_event_filter_expression();
                if (result15 !== null) {
          ...
          if (result4 !== null) {
            ...
            if (result7 !== null) {
              ...
              if (result8 !== null) {
                var result9 = parse__();
                if (result9 !== null) {
                  var result10 = parse_event_group_expression();
                  if (result10 !== null) {
      ...
      function parse_event_group_expression() {
        var cacheKey = 'event_group_expression@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        var result13 = result12 !== null
          ? (function(member) { return member; })(result12[4])
          : null;
        if (result13 !== null) {
        ...
        if (result11 !== null) {
          ...
          var result3 = result2 !== null
            ? (function(member) { member.multi = true; return member; })(result2[4])
            : null;
          if (result3 !== null) {
            var result1 = result3;
          } else {
