...
Measurement.prototype.measure = function measure(db, callback) {
  ...
  compute[this.flavor].call(this, db, function(time, value, values){ callback(new Metric(time, value, _this, values)); });
};
...
function unary(db, callback) {
  ...
  function task() {
    findOrComputeUnary.call(self, db, function(time, value, values) {
